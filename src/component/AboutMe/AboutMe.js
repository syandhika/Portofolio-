            ...
            <div id="aboutMe">
                ...
                <Row>
                    <Col span={24} style={{ display: 'flex', justifyContent: 'center' }}>
                        <div className='Border-Open-Text-Aboutme'></div>
                    </Col>
                </Row>
                <Row>
                    <Col span={24} style={{ display: 'flex', justifyContent: 'center' }} >
                        <div className='Border-Mid-Text-Aboutme'>
                ...
                <Row>
                    <Col span={24} style={{ display: 'flex', justifyContent: 'center' }}>
                        <div className='Border-Close-Text-Aboutme'></div>
                    </Col>
                </Row>

                {/* Session Skill & Education */}

                <Row>
                    <Col span={24} style={{ display: 'flex', justifyContent: 'center' }}>
                        <div className='Border-Top-Skills'>
                        </div>
                    </Col>
                </Row>
                <Row>
                ...
                <Row>
                    <Col span={24} style={{ display: 'flex', justifyContent: 'center' }}>
                        <div className='Border-Bot-Skills'></div>
                    </Col>
                </Row>
            </div>
        </>
